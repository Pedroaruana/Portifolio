...
const translations = {
  en: {
    ...
    'about.p1': 'Hi! My name is <strong>Pedro Aruanã</strong>, I\'m <strong>23 years old</strong> and I\'m from Salvador, Bahia. I\'ve been coding for <strong>2 years</strong> and I\'m a front-end developer with full stack experience too — I like taking an ordinary site or system and turning it into an experience people remember. I\'m always learning and testing new technologies hands-on, not just in theory. I\'m also C1-certified in English by EF SET, and I keep up daily practice and commits on GitHub.',
    'about.p2': "I'm proficient in React and Angular on the interface, but I build the whole system: REST APIs with Node.js and FastAPI, JWT authentication, automated tests with Vitest and Playwright, deployment with Docker, CI/CD and automation with n8n. I'm currently studying and testing hosting with AWS.",
    ...
    'skills.step1-title': '01 · Open the laptop',
    'skills.step1-desc': 'Environment set up, repo initialized and first branch created.',
    'skills.step2-title': '02 · Screen turns on',
    'skills.step2-desc': 'Dev server running with hot reload.',
    'skills.step3-title': '03 · Frontend',
    'skills.step3-desc': "Components, routes and the store's responsive layout.",
    'skills.step4-title': '04 · Backend',
    'skills.step4-desc': 'REST API with authentication and business rules.',
    'skills.step5-title': '05 · Database',
    'skills.step5-desc': 'Modeling, migrations and optimized queries.',
    'skills.step6-title': '06 · Automated tests',
    'skills.step6-desc': 'Unit and end-to-end tests running on every commit.',
    'skills.step7-title': '07 · Docker',
    'skills.step7-desc': 'Same environment on any machine, no surprises.',
    'skills.step8-title': '08 · CI/CD',
    'skills.step8-desc': 'Build, test and publish without a single manual step.',
    'skills.step9-title': '09 · Automation',
    ...
    'skills.check4': 'Tests passing',
    'skills.check5': 'Container published',
    'skills.check6': 'Pipeline green',
    'skills.check7': 'Automation active',
    'skills.check8': 'Store live',
    'skills.ready': 'Store ready',
    'exp.label': '/ experience',
    'exp.title': 'Professional Experience',
    'exp.role-label': 'ROLE',
    'exp.role': 'Apprentice — Marketing & IT Support',
    'exp.location': 'Salvador, BA · On-site',
    'exp.period': 'Jul 2024 – May 2025',
    ...
    'exp-taskflow.role': 'Tech Lead — TaskFlow (Open Source)',
    'exp-taskflow.period': 'Aug 2026 – present',
    'exp-taskflow.duration': 'Open Source · Tech Lead',
    'exp-taskflow.location': 'Brazil · Remote',
    'exp-taskflow.bullet1': 'On the frontend (<strong>React/TypeScript</strong>), built the full password recovery flow — forgot password, OTP verification and password reset — reusing the project\'s existing components',
    'exp-taskflow.bullet2': 'On mobile (<strong>React Native/Expo</strong>), implemented the sign-up and login screens from scratch, creating reusable input, button and header components, plus the full password recovery flow reusing those components',
    'exp-taskflow.bullet3': 'On desktop (<strong>C#/WinForms</strong>), built the sign-up, login and password recovery screens, extracting a reusable brand panel and a password field component with a show/hide toggle, following the project\'s design system (Figma)',
    'exp-taskflow.bullet4': 'Reviewed and approved other contributors\' pull requests as the project\'s Tech Lead',
    'exp-taskflow.repo': 'View repository on GitHub',
    'exp-bomcv.role': 'Full Stack Developer — Open Source',
    'exp-bomcv.period': 'Jul 2026 – present',
    'exp-bomcv.duration': '3 months · Part-time',
    'exp-bomcv.location': 'Brazil · Remote',
    'exp-bomcv.bullet1': 'Contributed to Bom Currículo, an open-source platform that generates ATS-optimized resumes, with PRs merged into the official repo — working across frontend, backend and the Python AI bot',
    'exp-bomcv.bullet2': 'On the frontend, built the resume data confirmation screen in <strong>React/TypeScript</strong>, with checkboxes pre-checked for each extracted experience, plus set up automated tests with <strong>Vitest</strong>',
    'exp-bomcv.bullet3': 'On the Python bot, implemented ingestion of CV, LinkedIn, GitHub and skills data to generate the resume with AI, set up the CI pipeline and built the test suite with <strong>pytest</strong>',
    'exp-bomcv.bullet4': 'On the backend, wrote the full Swagger documentation for the API, covering the 14 authentication, profile and resume endpoints',
    'exp-bomcv.repo': 'View repository on GitHub',
    'edu.label': '/ education',
    ...
    'proj.cap4': 'DEV TOOL',
    'proj.cap5': 'ORBITAL TRACKING',
    'proj.cap6': 'AUTOMATION',
    'proj.cap7': '3D SIMULATOR',
